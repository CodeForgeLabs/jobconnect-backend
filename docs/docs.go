                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.CreatePortfolioItemRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.UpdatePortfolioItemRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "domain.Job": {
            ...
            "properties": {
                ...
                "experience_level": {
                    "$ref": "#/definitions/domain.ExperienceLevel"
                },
                "hourly_rate": {
                    "description": "hourly job fields",
                    "type": "number"
                },
                "id": {
                    "type": "integer"
                ...
                "location": {
                    "description": "location (only for onsite/hybrid)",
                    "type": "string"
                },
                "max_weekly_hours": {
                    "type": "integer"
                ...
                "work_mode": {
                    "$ref": "#/definitions/domain.WorkMode"
                }
            }
        },
        "domain.JobStatus": {
        ...
        "handlers.CreatePortfolioItemRequest": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
        ...
        "handlers.UpdatePortfolioItemRequest": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
